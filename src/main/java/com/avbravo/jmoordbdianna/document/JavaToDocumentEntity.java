 ...
 */
package com.avbravo.jmoordbdianna.document;

import com.avbravo.jmoordbdianna.beans.EmbeddedBeans;
import com.avbravo.jmoordbdianna.beans.JmoordbException;
import com.avbravo.jmoordbdianna.beans.ReferencedBeans;
import com.avbravo.jmoordbdianna.util.ClassDescriptor;
import com.avbravo.jmoordbdianna.util.ClassDescriptorsCache;
import com.avbravo.jmoordbdianna.util.FieldDescriptor;
import com.avbravo.jmoordbdianna.util.ReflectionUtils;
 ...
 * @author avbravo
 */
public class JavaToDocumentEntity {
    ...
    public DocumentEntity toDocument(String collection,Object obj, List<EmbeddedBeans> embeddedBeansList, List<ReferencedBeans> referencedBeansList) {
        if (obj == null) {
            return null;
        }
   ...
   DocumentEntity dbObject = DocumentEntity.of(collection);
        ...
        for (FieldDescriptor fieldDescriptor : classDescriptor.getFields()) {
            ...
            dbObject.add(fieldDescriptor.getName(), toDBObjectRecursive(obj, fieldDescriptor, embeddedBeansList, referencedBeansList));
